...
( '', '".$row->id."', '', '', '', 'par_TV', 2, '1' )";
    ...
    Html_edithugeit_contact($id, $ord_elem, $count_ord, $images, $row, $cat_row, $rowim, $rowsld, $paramssld, $rowsposts, $rowsposts8, $postsbycat, $form_styles,$style_values);
  }
...
( '', '".$row->id."', '', '".$_POST["imagess"]."', '', 'par_TV', 2, '1' )";
    ...
    $wpdb->query($sql_huge_it_contact_contacts_fields);
      ...
      $wpdb->query($sql_2);
	    ...
	    if(isset($_POST["popupposts"]) and $_POST["popupposts"] != 'none' and $_POST["popupposts"] != ''){
